      ...
      >
        ...
        <div className="flex items-center gap-2 md:gap-7">
          <div className="hidden md:flex items-center gap-7 text-[13.5px] text-[var(--color-ink)]">
            <Link href="/work" className="hover:text-[var(--color-magenta)] transition-colors">Work</Link>
            <Link href="/studio" className="hover:text-[var(--color-magenta)] transition-colors">Studio</Link>
            <Link href="/journal" className="hover:text-[var(--color-magenta)] transition-colors">Journal</Link>
          </div>
          <a
